...
public extension GetterGenerator {
	public func split<S, A, G1: GetterGenerator, G2: GetterGenerator where G1.Source == S, G1.Target == A, G2.Source == (Source, S), G2.Target == (Target, A)>(_ other: G1) -> G2 {
		return G2(get:
			{ (s1, s2) in
	...
	public func choice<S, G1: GetterGenerator, G2: GetterGenerator where G1.Source == S, G1.Target == Target, G2.Source == Either<Source, S>, G2.Target == Target>(_ other: G1) -> G2 {
